...
def get_parser(desc, default_task="translation"):
    ...
    parser.add_argument("--mor_path", default='iwslt14deen_bpe-then-morBig-morNonAt_res.json', help="mor_path",
                        type=str)
    parser.add_argument("--emb_rank", default=8, help="emb_rank", type=int)
    parser.add_argument("--emb_mode", default='morphTE', help="emb_mode", type=str)
